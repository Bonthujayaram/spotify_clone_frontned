...
const MusicCard = ({ track, playlist, playlists: propPlaylists, className, title: customTitle, subtitle: customSubtitle, image: customImage, onRemove }: MusicCardProps) => {
  ...
  return (
    <div 
      className={cn(
        ...
        "w-full max-w-[200px] sm:w-[180px] md:w-[200px]",
        className
      )}
    >
      <div className="p-2 sm:p-3">
        <div className="aspect-square mb-2 sm:mb-3 rounded-md overflow-hidden relative group/card">
          <img 
            src={displayImage}
            alt={displayTitle}
            className={cn(
        ...
        <div className="space-y-1 min-h-[3rem]">
          <h3 
            className={cn(
              "font-medium line-clamp-1 transition-colors duration-200 text-base sm:text-lg",
          ...
          {displaySubtitle && (
            <p 
              className="text-xs sm:text-sm text-gray-400 line-clamp-1"
