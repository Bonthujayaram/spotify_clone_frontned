...
const Library = () => {
  ...
  const { recentlyPlayed: playerRecentlyPlayed } = usePlayer();
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      try {
        ...
        const [{ likedSongs }, { playlists }, { recentlyPlayed }] = await Promise.all([
        ...
        setRecentlyPlayed(recentlyPlayed.map(item => item.track));
      } catch (error) {
